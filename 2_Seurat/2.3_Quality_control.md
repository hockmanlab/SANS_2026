...
In this tutorial dataset, **8,601 cells were present before QC and 8,598 cells remained after applying the selected thresholds**.
...
Because only **3 cells** were removed by the selected thresholds, the post-filtering distributions are expected to be essentially unchanged from the pre-filtering distributions.
...
- confirmed that 8,598 cells remained after filtering; and

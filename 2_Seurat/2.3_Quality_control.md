...
## 8. Calculating Mitochondrial RNA Percentage
...
![Pre-filtering QC violin plots](images/pre_filter_violin_plot.png)
...
This means that **none of the 5,000 cells in this downsampled dataset exceeded the selected QC thresholds**.
...
> **Important for this tutorial:** The analysis was previously downsampled to **5,000 cells** for testing because of computational constraints. Therefore, the result of 0 cells removed applies to this **5,000-cell tutorial subset**, not necessarily to the complete original dataset of 8,601 cells.

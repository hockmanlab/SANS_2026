...
if (TRUE){
  ...
  saveRDS(
    seu,
    file = "Documents/AA_UCT/singlecell_workshop/seurat_preprocessed_SCT.rds" # Replace with path to your directory
  )
...
seu <- readRDS("Documents/AA_UCT/singlecell_workshop/seurat_preprocessed_SCT.rds") # Replace with path to your directory

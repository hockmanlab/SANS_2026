...
4. Open `clustering_annotation_BA.R` or `clustering_annotation_BA.Rmd` in RStudio.
...
If you are unable to run the analysis during the practical, open `clustering_annotation_BA.html` to follow the workflow and view the expected results.

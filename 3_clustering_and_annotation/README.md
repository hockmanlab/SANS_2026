...
\`\`\`text Pre-processed Seurat object ↓ PCA ↓ Select principal PCs ↓
Find neighbours ↓ Clustering ↓ Compare resolutions ↓ UMAP ↓ Identify
markers ↓ Manual annotation ↓ Reference annotation (Azimuth)
